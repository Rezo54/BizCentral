...
export default function CrateAdminRouteTable({rows,rates}:{rows:Recon[];rates:Rate[]}){
  ...
  const sorted=useMemo(()=>[...rows].sort((a,b)=>{
    const short=(r:Recon)=>Math.max(0,r.crate.currentOutstanding);
